  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        backgroundColor: const Color(0xFFCC7722), // Ochre background color
      ),
      drawer: Drawer(
        child: ListView(
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const IotMonitoringDataPage()),
                );
              },
            ),
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const IotControllingPage()),
                );
              },
            ),
            ListTile(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              const CircleAvatar(
                radius: 80,
                backgroundImage: AssetImage('assets/isyrafgmbr.jpg'),
              ),
